...
export const pageQuery = graphql`
  query queryAll {
    all: markdownRemark(
      fields: { slug: { eq: "/docs/v0.4/zh-CN/installation/allinone" } }
    ) {
      html
      frontmatter {
        title
    ...
    kubernetes: markdownRemark(
      fields: { slug: { eq: "/docs/v0.4/zh-CN/installation/kubernetes" } }
    ) {
      html
      frontmatter {
        title
    ...
    helm: markdownRemark(
      fields: { slug: { eq: "/docs/v0.4/zh-CN/installation/helm-chart" } }
    ) {
      html
      frontmatter {
        title
